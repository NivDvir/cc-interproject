...
(`~/.claude/interproject.manifest.json`, schema 1 — see DESIGN.md §5).
"""
...
from cc_interproject import VERSION, paths
from cc_interproject.run_state import Run

KIT_URL = "https://github.com/NivDvir/cc-interproject"
...
def load(path: Path) -> dict | None:
    ...
    try:
        ...
        print(f"cc-interproject: could not read manifest {path}: {exc}", file=sys.stderr)  # noqa: T201
        return None
