"""Read the kit's static public-text files (INTERPROJECT_LAWS.md, PRIOR_ART.md, and the rest).
...
def read(name: str) -> str:
    """Return the text of one file this package ships, e.g. "INTERPROJECT_LAWS.md"."""
