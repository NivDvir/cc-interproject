Inter-project constitution: read ~/.claude/SIX_LAWS.md before any cross-project work (installed by six-laws-kit).

---

The files under `~/.claude` are the authority for how the Claude Code projects on this machine work
together: `SIX_LAWS.md`, `PROJECT_REGISTRY.md`, `INTERPROJECT_PROTOCOL.md`, `PRIOR_ART.md`, and
`DISPATCHER_QUEUE.md`.
