# six-laws-kit — subtree of ~/opportunity-radar
...
Projects as a System" apply the six-law setup to the Claude Code projects on their own machine.
...
code), `docs/STYLE.md` (the style contract), `../../publication/six-laws-kit/SPEC.md` (the agreed
